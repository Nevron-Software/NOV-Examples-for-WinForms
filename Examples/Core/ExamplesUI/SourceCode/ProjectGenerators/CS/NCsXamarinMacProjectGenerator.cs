...
{
	internal class NCsXamarinMacProjectGenerator : NCsProjectGenerator
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static NCsXamarinMacProjectGenerator()
		{
		...
		protected override NEmbeddedResource ProjectTemplate
		{
			get
			{
				return NResources.RBIN_ProjectTemplates_CS_NovXamarinMacProject_zip;
			}
		}
		/// <summary>
		...
		protected override string MainSourceCodeFileName
		{
			get
			{
				return "NovXamarinMacProject/MainWindow.cs";
			}
		}
