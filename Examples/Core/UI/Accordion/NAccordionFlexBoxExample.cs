...
{
	public class NAccordionFlexBoxExample : NExampleBase
	{
		#region Constructors

		public NAccordionFlexBoxExample()
		{
		}

		static NAccordionFlexBoxExample()
		{
            NAccordionFlexBoxExampleSchema = NSchema.Create(typeof(NAccordionFlexBoxExample), NExampleBaseSchema);
		}
...
";
		...
		public static readonly NSchema NAccordionFlexBoxExampleSchema;
