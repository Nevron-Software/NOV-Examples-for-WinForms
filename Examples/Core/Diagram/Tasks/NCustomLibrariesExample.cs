...
{
	public class NCustomLibrariesExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NCustomLibrariesExample()
		{
		}
		...
		/// Static constructor.
		/// </summary>
		static NCustomLibrariesExample()
		{
			NCustomLibrariesExampleSchema = NSchema.Create(typeof(NCustomLibrariesExample), NExampleBaseSchema);
		}
...
<p>If you want to open a NOV Diagram library file or a Visio Stencil, use the <b>Open Library</b> button on the right.</p>";
		...
		private NLibraryDocument CreateLibraryDocument()
		{
		...
		/// </summary>
		public static readonly NSchema NCustomLibrariesExampleSchema;
