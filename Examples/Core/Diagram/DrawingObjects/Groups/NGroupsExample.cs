...
namespace Nevron.Nov.Examples.Diagram
{
	...
	public class NGroupsExample : NExampleBase
	{
		...
		protected NGroup CreateNetwork(NPoint location, string labelText)
		{
			...
			NBatchGroup<NShape> batchGroup = new NBatchGroup<NShape>(m_DrawingView.Document);
		...
		{
			NShape computerShape = NLibrary.FlowchartShapes.CreateShape(ENFlowchartingShape.Database);
			return computerShape;
		}

		private void ConnectNetworks(NGroup fromNetwork, NGroup toNetwork)
		{
			NShape lineShape = m_ConnectorShapes.CreateShape(ENConnectorShape.Line);
