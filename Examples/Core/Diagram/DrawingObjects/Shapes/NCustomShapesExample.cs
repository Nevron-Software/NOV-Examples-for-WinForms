...
{
	public class NCustomShapesExample : NExampleBase
    {
        #region Constructors
        ...
        {
            NCustomShapesExampleSchema = NSchema.Create(typeof(NCustomShapesExample), NExampleBaseSchema);
        }
...
<p>
    ...
    Note that the geometry, left and right ports and XControl point behavior of this shape are driven by formula expressions.
        ...
        /// </summary>
        /// <returns></returns>
        private NShape CreateCoffeeCupShape()
        {
        ...
        /// </summary>
        /// <returns></returns>
        private NShape CreateTrapedzoidShape()
        {
		...
		private void Interaction_GluingShapes(NGlueShapesEventArgs args)
        {
