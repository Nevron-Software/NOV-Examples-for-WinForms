...
{
	public class NFileAndFolderShapesExample : NDiagramExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NFileAndFolderShapesExample()
		{
		}
		...
		/// Static constructor.
		/// </summary>
		static NFileAndFolderShapesExample()
		{
			NFileAndFolderShapesExampleSchema = NSchema.Create(typeof(NFileAndFolderShapesExample), NDiagramExampleBase.NDiagramExampleBaseSchema);
		}
		...
		protected override void InitDiagram()
		{
			...
			try
			{
				...
				// Create all shapes
				NFileAndFolderShapeFactory factory = new NFileAndFolderShapeFactory();
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
    This example demonstrates the file and folder shapes, which are created by the NFilesAndFoldersShapesFactory.
</p>
";
		}
		...
		/// <summary>
		/// Schema associated with NFileAndFolderShapesExample.
		/// </summary>
		public static readonly NSchema NFileAndFolderShapesExampleSchema;
