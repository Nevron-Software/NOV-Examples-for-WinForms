...
{
	public class NThemeBasedColorsExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NThemeBasedColorsExample()
		{
		}
		...
		/// Static constructor.
		/// </summary>
		static NThemeBasedColorsExample()
		{
			NThemeBasedColorsExampleSchema = NSchema.Create(typeof(NThemeBasedColorsExample), NExampleBaseSchema);
		}
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create colors whose actual values are determined by 
	the currently selected page theme and page theme variant. To do that, set
	the <b>Tag</b> property of the specific NColor to a theme based color info.
</p>
<p>
	...
	the ribbon to see how the style of the shape will change.
		...
		/// </summary>
		public static readonly NSchema NThemeBasedColorsExampleSchema;
