...
{
	public class NArrowShapesExample : NExampleBase
	{
		#region Constructors
		...
		{
			NArrowShapesExampleSchema = NSchema.Create(typeof(NArrowShapesExample), NExampleBaseSchema);
		}
		...
		{
			return @"<p>This example shows the arrow shapes located in the ""General\Arrows.nlb"" shape library.</p>";
		}
		...
		private void InitDiagram(NDrawingDocument drawingDocument)
		{
			...
			NFile libraryFile = NApplication.ResourcesFolder.GetFile(NPath.Current.Combine(
					"ShapeLibraries", "General", "Arrows.nlb"));
